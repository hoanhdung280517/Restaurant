...
namespace RSSolution.Data.Migrations
{
    ...
    [Migration("20210812052640_user-1.9")]
    partial class user19
    {
            ...
            modelBuilder.Entity("RSSolution.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "6458b745-1752-44a6-8452-110d0b43ecae",
            ...
            modelBuilder.Entity("RSSolution.Data.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "d95cecac-6b81-4230-ae01-251b23aebebc",
                            DistrictId = 1,
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEGILIBbA82RKEskRXLY0AHjfKVXG+WiBuNq4dg1OwzkC02Ipyy26GH3tIxZe1VSv5A==",
            ...
            modelBuilder.Entity("RSSolution.Data.Entities.Meal", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2021, 8, 12, 12, 26, 39, 570, DateTimeKind.Local).AddTicks(7333),
                            Price = 200000m,
                            ViewCount = 0
                        });
                });
