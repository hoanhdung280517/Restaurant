...
namespace RSSolution.Data.Migrations
{
    ...
    [Migration("20210823103407_user-2.3")]
    partial class user23
    {
            ...
            modelBuilder.Entity("RSSolution.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "d79197a3-a5e8-4064-8cfb-c62a282c6fab",
            ...
            modelBuilder.Entity("RSSolution.Data.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "f200c1ce-2cbc-4dd3-ac15-3f37798d3e45",
                            DistrictId = 1,
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEIazEMb0ld3iIBrLoru1NSHTRVhz2nM8FPDWKeysbB7QkPlCeHeDsJdRuhTkNi2P5g==",
            ...
            modelBuilder.Entity("RSSolution.Data.Entities.Meal", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2021, 8, 23, 17, 34, 6, 439, DateTimeKind.Local).AddTicks(310),
                            Price = 200000m,
                            ViewCount = 0
                        });
                });
