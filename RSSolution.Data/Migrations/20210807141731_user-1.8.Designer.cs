...
namespace RSSolution.Data.Migrations
{
    ...
    [Migration("20210807141731_user-1.8")]
    partial class user18
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RSSolution.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "ace3b6af-85f1-49fb-8e47-2f0f464512b2",
            ...
            modelBuilder.Entity("RSSolution.Data.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "28f936cf-0dca-44a8-ab80-8f4169fce1c1",
                            DistrictId = 1,
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEC3e4Wuf2ouPV3+wAPQdGIwoWuWmSIjk0ynQd7CzWZ7I/omBSimpzy0MkVpoaM+x0Q==",
            ...
            modelBuilder.Entity("RSSolution.Data.Entities.Meal", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2021, 8, 7, 21, 17, 30, 294, DateTimeKind.Local).AddTicks(5416),
                            Price = 200000m,
                            ViewCount = 0
                        });
                });
            ...
            modelBuilder.Entity("RSSolution.Data.Entities.Order", b =>
                {
                    b.HasOne("RSSolution.Data.Entities.Promotions", "Promotion")
                        .WithMany("orders")
