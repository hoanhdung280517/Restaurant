...
namespace RSSolution.Data.Migrations
{
    ...
    [Migration("20210819130402_user-2.1")]
            ...
            modelBuilder.Entity("RSSolution.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "6d47200e-7ae8-440d-8535-f9f0b52e00fe",
            ...
            modelBuilder.Entity("RSSolution.Data.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "79a223c5-f581-44d1-95cf-222fb50e84a0",
                            DistrictId = 1,
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEAcp21B3LK879DqlFcRBlcDUyRNvtP4ui+5VRM+IoGzrSQWxJDlAJiRj5nFywIkWlw==",
            ...
            modelBuilder.Entity("RSSolution.Data.Entities.Meal", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2021, 8, 19, 20, 4, 1, 411, DateTimeKind.Local).AddTicks(5824),
                            Price = 200000m,
                            ViewCount = 0
                        });
                });
