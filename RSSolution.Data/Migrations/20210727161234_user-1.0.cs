    ...
    public partial class user10 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MealCategoryTranslations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MealCategoryTranslations_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MealCategoryTranslations_MealCategories_MealCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MealInCategories", x => new { x.MealCategoryId, x.MealId });
                    table.ForeignKey(
                        name: "FK_MealInCategories_MealCategories_MealCategoryId",
                        column: x => x.MealCategoryId,
                        principalTable: "MealCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MealInCategories_Meals_MealId",
                        column: x => x.MealId,
                        principalTable: "Meals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MealTranslations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MealTranslations_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MealTranslations_Meals_MealId",
                        column: x => x.MealId,
                        principalTable: "Meals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderDetails", x => new { x.OrderId, x.MealId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MealCategoryTranslations_LanguageId",
                table: "MealCategoryTranslations",
                column: "LanguageId");

            migrationBuilder.CreateIndex(
                name: "IX_MealCategoryTranslations_MealCategoryId",
                table: "MealCategoryTranslations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MealInCategories_MealId",
                table: "MealInCategories",
                column: "MealId");

            migrationBuilder.CreateIndex(
                name: "IX_MealTranslations_LanguageId",
                table: "MealTranslations",
                column: "LanguageId");

            migrationBuilder.CreateIndex(
                name: "IX_MealTranslations_MealId",
                table: "MealTranslations",
                column: "MealId");
